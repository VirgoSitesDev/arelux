<script lang="ts">
	...
	let selectedPower = $state<{ baseModel: string; power: number; sampleCode: string } | undefined>();
...
<main class="grid h-dvh grid-cols-layout grid-rows-layout gap-5 p-5">
    ...
    {#if showPowerPanel && selectedSubfamily && !selectedPower}
                        ...
                        <div class="relative">
                            <img
                                ...
                                class={cn(
                                    ...
                                    selectedPower && (selectedPower as any).baseModel === model.baseModel && 'outline-4',
                                    loaded.has(url) || 'opacity-0',
                                )}
                            />
                            
                            {#if selectedPower && (selectedPower as any).baseModel === model.baseModel}
